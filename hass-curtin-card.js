  ...
  set hass(hass) {
    ...
    if (!this.card) {
      ...
      entities.forEach(function(entity) {
        ...
        let curtainColor = '#ffffff'
        if (entity && entity.curtain_color) {
          curtainColor = entity.curtain_color;
        }
        ...
        curtain.innerHTML = `
          ...
          <div class="sc-curtain-middle" style="flex-direction: ` + (buttonsPosition == 'right' ? 'row-reverse': 'row') + `;">
            <div class="sc-curtain-buttons">
              <ha-icon-button class="sc-curtain-button" data-command="up"><ha-icon icon="mdi:arrow-up"></ha-icon></ha-icon-button><br>
              <ha-icon-button class="sc-curtain-button" data-command="stop"><ha-icon icon="mdi:stop"></ha-icon></ha-icon-button><br>
              <ha-icon-button class="sc-curtain-button" data-command="down"><ha-icon icon="mdi:arrow-down"></ha-icon></ha-icon-button>
            </div>
        ...
        slide.style.background = curtainColor ;
